...
pandoc -N --variable "geometry=margin=1.2in" --variable mainfont='MesloLGS NF Regular' --variable sansfont='MesloLGS NF Regular' --variable monofont='MesloLGS NF Regular' --variable fontsize=12pt --variable version=2.0 book/book.tex  --pdf-engine=xelatex --toc -o book/book.pdf

echo -e "Book build: book/book.pdf\n"